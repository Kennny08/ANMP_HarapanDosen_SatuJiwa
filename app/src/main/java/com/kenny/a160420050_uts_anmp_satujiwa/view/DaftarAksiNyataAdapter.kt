...
class DaftarAksiNyataAdapter (val daftarAksiNyata: ArrayList<AksiNyata>) :
    ...
    override fun onBindViewHolder(holder: AksiNyataViewHolder, position: Int) {
        ...
        imgAksiNyata.loadImage("https://projectfspf.000webhostapp.com/projectutsanmp/images/" + daftarAksiNyata[position].fotoAksiNyata, progressBarImageAksiNyata)
        txtNamaPenggalangAksiNyata.text = daftarAksiNyata[position].namaPenggalang
        txtNamaAksiNyata.text = daftarAksiNyata[position].namaAksiNyata
        ...
        btnDetailAksiNyata.setOnClickListener{
            val action = DaftarAksiNyataFragmentDirections.actionDetailAksiNyata(daftarAksiNyata[position].id.toString())
    ...
    fun updateDaftarAksiNyata(newDaftarAksiNyata: ArrayList<AksiNyata>) {
